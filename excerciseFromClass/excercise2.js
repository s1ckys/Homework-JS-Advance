async function getData(){
    try{
        ...
        let anotherResponse = await fetch ("https://raw.githubusercontent.com/sedc-codecademy/skwd9-04-ajs/main/Samples/documents.json");
        let files = await anotherResponse.json();
